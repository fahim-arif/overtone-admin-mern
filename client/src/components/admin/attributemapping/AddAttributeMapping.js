...
class AddAttributeMapping extends Component {
  constructor(){
    super();
    this.state={
       errors:{},
...
componentWillReceiveProps(nextProps){
    ...
    if(nextProps.attributemapping.addattributemapping !== this.props.attributemapping.addattributemapping){
        Toast.fire({
            type: 'success',
            title: ' Attribute Mapping Added Successfully',
          })
          this.onReset();
          const parsed=queryString.parse(this.props.location.search)
          if(this.state.nextScreen){
            this.props.history.push(`/admin/addsub?productID=${parsed.productID}`)
          }
    }
...
onChange(e){
    ...
    if(e.target.name === "parentAttributeCategoryID"){
      var data={
        productID:this.state.productID,
        parentAttributeCategoryID:e.target.value
      }
      axios.post("/api/attributemapping/getposition",data)
      .then(result=>{
            var temp=result.data;
            this.setState({
              mappingName:temp.mappingName,
              postionReadOnly:true
            })
      })
      .catch(err=>{
        this.setState({
...
onSubmit(e){
    ...
    const Data ={  
      ...
      productID:this.state.productID,
      mappingName:this.state.mappingName.toString(),
    ...
    this.props.addAttributeMapping(Data);
}
        ...
        <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
          ...
          <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
            ...
            <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
              ...
              <div className="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                    <div className="kt-portlet">
                     <div className="kt-portlet__head">
                        ...
                        <div className="kt-portlet__head-label">
                        <button type="button" className={`btn btn-success`}>Add /Edit Sub-Products</button>
                        </div>
                    </div>
                    {/*begin::Form*/}
                    <form className="kt-form kt-form--fit kt-form--label-right" onSubmit={this.onSubmit}>
                        <div className="kt-portlet__body">
                             <div className="form-group row">
                                  ...
                                  <label className="col-lg-2 col-form-label">Position Of Parent Category:</label>
                                <div className="col-lg-3">
                                        <input type="number" disabled={this.state.postionReadOnly} name="mappingName" onChange={this.onChange} value={this.state.mappingName} className="form-control" placeholder="" />
                                        <span className="form-text text-danger">{errors.mappingName}</span>
                                        <span className="form-text">Position for sorting parent category</span>
                                </div>
                        ...
                        <div className="kt-portlet__foot kt-portlet__foot--fit-x">
                            ...
                            <div className="col-lg-5 d-flex justify-content-around">
                                <button type="submit" className={`btn btn-success ${attributemappingloading ?  'kt-spinner kt-spinner--sm kt-spinner--light':''}`}>Save & Add Another</button>
                                <button type="button" onClick={()=>{
                                  this.setState({nextScreen:true},()=>{
                                    this.onSubmitNext()
                                  })
                                }} className={`btn btn-warning ${attributemappingloading ?  'kt-spinner kt-spinner--sm kt-spinner--light':''}`}>Save & Next</button>
             ...
             <ListAttributeMapping history={this.props.history} location={this.props.location}/>
              {/* end:: Content */}
            </div>
            {/* begin:: Footer */}
            <Footer/>
...
export default connect(mapStateToProps,{addAttributeMapping,listParentAttributeCategory,listAttributeCategory,listProduct})(AddAttributeMapping);