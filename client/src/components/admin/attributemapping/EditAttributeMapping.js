...
componentDidMount(){
  ...
  this.setState({
      _id:editResult._id,
       ...
       subField:editResult.dependentField ?"Yes":"No",
  })
                    ...
                    <form className="kt-form kt-form--fit kt-form--label-right" onSubmit={this.onSubmit}>
                        <div className="kt-portlet__body">
                             <div className="form-group row">
                                ...
                                <div className="col-lg-3">
                                        <input type="number" name="mappingName" onChange={this.onChange} value={this.state.mappingName} className="form-control" placeholder="" />
